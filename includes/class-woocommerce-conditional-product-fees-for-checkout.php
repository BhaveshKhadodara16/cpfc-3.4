...
class Woocommerce_Conditional_Product_Fees_For_Checkout_Pro {
	...
	private function define_admin_hooks() {
		...
		if ( wcpffc_fs()->is__premium_only() ) {
			if ( wcpffc_fs()->can_use_premium_code() ) {
				...
				$this->loader->add_action( 'wp_ajax_wcpfc_pro_product_fees_conditions_varible_values_product_ajax__premium_only', $plugin_admin, 'wcpfc_pro_product_fees_conditions_varible_values_product_ajax__premium_only' );
				...
				$this->loader->add_action( 'wp_ajax_wcpfc_pro_simple_and_variation_product_list_ajax__premium_only', $plugin_admin, 'wcpfc_pro_simple_and_variation_product_list_ajax__premium_only' );
			}
		}
	...
	private function define_public_hooks() {
		...
		$this->loader->add_filter('woocommerce_paypal_args',$plugin_public,'paypal_bn_code_filter_conditional_fee',99,1);
	}
	/**
	...
	public function plugin_action_links( $actions ) {
		$custom_actions = array(
			'configure' => sprintf( '<a href="%s">%s</a>', esc_url( add_query_arg( array( 'page' => 'wcpfc-pro-list' ), admin_url( 'admin.php' ) ) ), __( 'Settings', $this->plugin_name ) ),
