		...
		<header class="dots-header">
			...
			<div class="dots-header-right">
				<div class="logo-detail">
					...
					<span><?php esc_html_e( WCPFC_PRO_PREMIUM_VERSION, 'woocommerce-conditional-product-fees-for-checkout' ); ?><?php echo esc_html( $plugin_version ); ?></span>
				</div>
							...
							if ( wcpffc_fs()->can_use_premium_code() ) {
								...
								<span class="support_dotstore_image">
                                    <a target="_blank" href="<?php echo esc_url( $wcpffc_fs->get_account_url() ); ?>">
                                            <img
	                                            src="<?php echo esc_url( WCPFC_PRO_PLUGIN_URL . 'admin/images/account_new.png' ); ?>">
                                    </a>
                                </span>
								<?php
							}
					...
					<div class="button-dots">
                        <span class="support_dotstore_image">
                            <a target="_blank" href="<?php echo esc_url( 'http://www.thedotstore.com/support/' ); ?>">
                                <img
	                                src="<?php echo esc_url( WCPFC_PRO_PLUGIN_URL . 'admin/images/support_new.png' ); ?>">
                            </a>
                        </span>
					</div>
				</div>
